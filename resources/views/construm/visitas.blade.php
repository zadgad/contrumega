            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Lista de las empresas a visitar por el empleado</h5>
                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Lista Visitas</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card table-card">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3>Lista de Empresas a Visitar</h3>
                    </div>
                                ...
                                <tbody>
                                 ...
                                 <td class="td-actions text-right">
                                       @if ($counts==0)
                                             ...
                                             <a href="{{route('cofirmarv',$sel->id_emp)}}"><i class="ik ik-edit f-16 mr-15 text-green"></i></a>
                                             <a href="{{route('verempre',$sel->id_emp)}}"><i class="ik ik-eye f-16 mr-15 text-green"></i></a>
                                            </form>
